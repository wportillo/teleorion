...
function emailFormSubmission()
{
	...
	$subject = 'Envío de member layout Form';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U12902"],ENT_COMPAT,'UTF-8') . '</td></tr>';
