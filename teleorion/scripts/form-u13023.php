...
function emailFormSubmission()
{
	...
	$to = 'CARLOS@EBAUZA.COM';
	$subject = 'Envío de General Layout Form';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U13040"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: CARLOS@EBAUZA.COM' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.30 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
